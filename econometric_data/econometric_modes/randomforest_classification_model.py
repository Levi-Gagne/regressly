# regressly/econometric_data/econometric_modes/randomforest_classification_model.py 
...
def display_widgets():
    """
    Display widgets for Random Forest Classification variable selection.
    """
    ...
    # Streamlit widgets
    st.header("Random Forest Classification Variable Selection")
